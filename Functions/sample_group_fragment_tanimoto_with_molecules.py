...
def sample_group_fragment_tanimoto_with_molecules(aligned_intensity_df,
                                                  ...
                                                  smooth_idf = False):
    """
    Calculate a feature-feature Tanimoto matrix using biological sample-group
    filtering.

    Features:
        features whose assignment contains the selected biological group
        plus molecule features from molecules_df.

    Fragments:
        fragments whose assignment contains the selected biological group.

    Example biological group:
    ...
    group_feature_ids, selected_feature_sample_types = ids_from_assignment_sample_groups(
    ...
    group_fragment_ids, selected_fragment_sample_types = ids_from_assignment_sample_groups(
    ...
    summary = {"carbon_sources": carbon_sources,
               "sample_sources": sample_sources,
               "original_sample_types": original_sample_types,
               "clean_status": clean_status,
               "selected_feature_sample_types": selected_feature_sample_types,
               "selected_fragment_sample_types": selected_fragment_sample_types,
