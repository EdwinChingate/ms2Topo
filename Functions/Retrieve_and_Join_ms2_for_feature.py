...
def Retrieve_and_Join_ms2_for_feature(context,
                                      params):
    """
    Retrieve and join MS2 spectra for the current feature module.

    Expected context keys:
        All_FeaturesTable, Feature_module, SamplesNames

    Relevant params:
        params["columns"]["sample_id_col"]
        params["columns"]["ms2_spec_id_col"]
        params["io"]["ms2Folder"]
        params["io"]["ToAdd"]
        params["io"]["Norm2One"]
    """
    ...
    ms2Folder = params["io"]["ms2Folder"]
    ToAdd = params["io"]["ToAdd"]
    Norm2One = params["io"]["Norm2One"]
