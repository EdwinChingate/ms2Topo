...
def compress_features_by_experiment(features_df,
    ...
    sample_experiments_df[sample_id_col] = (
        sample_experiments_df[sample_id_col]
        .astype(str)
        .str.strip()
    )
    ...
    sample_experiments_df["sample_col"] = (
        sample_experiments_df[sample_id_col]
        .map(feature_col_lookup)
    )

    sample_experiments_df = sample_experiments_df.dropna(
        subset=["sample_col"]
    )
