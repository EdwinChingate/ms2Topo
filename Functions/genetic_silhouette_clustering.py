...
def genetic_silhouette_clustering(CosineMat,
    ...
    random_individuals_population, population_matrix = random_population_modules_vectors_generator(population_matrix = np.array(population),
                                                                                                   n_nodes = n_nodes,
    ...
    while convergence_count < stable_iterations:
        offspring, population_matrix = population_crossover(population_matrix = population_matrix,
                                                            population = population)
        population, population_matrix = mutating_population(population_matrix = population_matrix,
