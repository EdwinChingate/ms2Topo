...
def unique_archetype_fragment_tanimoto_with_molecules(aligned_intensity_df,
                                                      ...
                                                      smooth_idf = False):
    """
    Calculate feature-feature similarity for one exact archetype group, while
    forcing molecule features into the Tanimoto matrix.

    Features:
        features whose best_archetype == group
        plus features listed in molecules_df
    ...
    group_feature_ids = ids_with_best_archetype(assignments = assignments_features,
                                                group = group,
