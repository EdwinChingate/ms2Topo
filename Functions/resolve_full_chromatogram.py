...
def resolve_full_chromatogram(mz,mz_std,AllRawPeaks,stdDistance=3,RT_tol=5,minSignals=5,SavePeaks=False,mz_name='-mz'):
    ...
    for Chromatogram in ChromatogramList:
        GaussianParameters=resolving_gaussian_chromatogram(Chromatogram=Chromatogram,RT_col=2,int_col=1,MaxSignals=100,distance=2)
